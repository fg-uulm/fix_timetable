...
var statictext2 = group2.add("statictext", undefined, undefined, {name: "statictext2"}); 
    statictext2.text = "0";
    statictext2.preferredSize.width = 15; 
...
for (var n = 0; n < items.length; n++) {
        ...
        if (dAll <= maxDist) {
                ...
                if(!labelPrev.split(",").includes(labWeek) && considerLabweek) {
                ...
                //Add lab week if enabled and not already there
                if(!labelPrev.split(",").includes(labWeek) && considerLabweek && labWeek % 2 == 1) {
                        items[n].label += ","+labWeek;
                        $.writeln("DEBUG: Add lab week " + labWeek); 
                }
                ...
                //Add lab week if enabled and not already there
                if(!labelPrev.split(",").includes(labWeek) && considerLabweek && labWeek % 2 == 0) {
                        items[n].label += ","+labWeek;
                        $.writeln("DEBUG: Add lab week " + labWeek); 
                }
